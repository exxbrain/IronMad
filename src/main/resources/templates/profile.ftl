    ...
    <form method="post">
        <div class="form-group row">
            <label for="exampleInputPassword1">Пароль</label>
                <input type="password" nameChannel="password" id="exampleInputPassword1"
        ...
        <div class="form-group row">
            ...
            <input type="email" nameChannel="email" class="form-control" id="exampleFormControlEmail" placeholder="som@som.com" value="${email!''}"/>
        </div>
